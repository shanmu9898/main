...
****
* Students specified by the `INDEX` are added in the class.
...
****
* Task with `TITLE` which needs to complete before `END_DATE` at `END_TIME` is added.
...
=== Listing all contacts/tasks/appointments : `list`
