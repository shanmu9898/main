...
Adding a default contact: `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` +
Adding a student contact: `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Centre Street, block 238, #02-02`
