...
* `list shortcuts`: lists all shortcuts.
...
export all contacts with tag student to an xml file named `StudentsFile1` in the `data` folder.
* `export n/StudentsFile2 r/1,10 t/students p/./data te/excel` : +
export contacts from 1 to 10 with tag students to an excel file named `StudentsFile2` in the `data` folder.
...
* `shortcut list l` : typing `l` is now equivalent to typing `list`.
* `shortcut add a` : typing `a` is now equivalent to typing `add`.
...
* `delete_shortcut list l` : typing `l` is no longer equivalent to typing `list`.
* `delete_shortcut add a` : typing `a` is no longer equivalent to typing `add`.
