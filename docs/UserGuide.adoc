...
* List all student: `list students` +
* List all task: `list tasks` +
* List all command shortcut: `list shortcuts`
...
* Deletes the Personalised Alias : `delete_shortcut list l`
* Deletes the Personalised Alias : `delete_shortcut add a`
