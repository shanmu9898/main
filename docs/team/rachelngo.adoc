...
** Added tag colour to `PersonCard` 's tags. (Pull Request https://github.com/CS2103JAN2018-W14-B1/main/pull/5[#5])
** Added toggle Calendar View mode command. (Pull Request https://github.com/CS2103JAN2018-W14-B1/main/pull/84[#84])
** Modified `list` command to allow toggling of list displayed on GUI. (Pull Request https://github.com/CS2103JAN2018-W14-B1/main/pull/91[#91])
** Improved User Interface design by rearranging position of components in the app, modifying the appearance of cards displayed in the item list and adding app logo and app name. (Pull Request https://github.com/CS2103JAN2018-W14-B1/main/pull/155[#155], https://github.com/CS2103JAN2018-W14-B1/main/pull/158[#158])
** Added 2 new themes for the GUI: `light` and `galaxy`. (Pull Request https://github.com/CS2103JAN2018-W14-B1/main/pull/89[#89])
...
** Fixed bugs for various issues raised by other teammates and testers. (Pull Request https://github.com/CS2103JAN2018-W14-B1/main/pull/143[#143], https://github.com/CS2103JAN2018-W14-B1/main/pull/162[#162])
** Integrated third party library `CalendarFX` to TeachConnect. (Pull Request https://github.com/CS2103JAN2018-W14-B1/main/pull/83[#83])
