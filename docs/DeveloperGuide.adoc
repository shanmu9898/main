...
* need to manage a significant number of students and parents contact details
* need to keep track of appointments with parents, students or other staff
* need to keep track of tasks and their deadlines
